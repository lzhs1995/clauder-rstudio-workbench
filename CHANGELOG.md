...
- Add 14 unit tests for worker-lint (clean/sink/commented-sink/missing-file, plan/run BLOCK paths) and auto-scale (scale-up under low memory, throttle under high memory, hold on unknown memory, `--max-parallel-cap` ceiling).
